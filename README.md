...
Finally, of our two candidate defense approaches, the anti-repairedNet defense generally has a high clean classification accuracy across all the models (about 83% in the worst case) while the improved fine-pruning defense has the lowest attack success rate (about 4% in the worst case).
